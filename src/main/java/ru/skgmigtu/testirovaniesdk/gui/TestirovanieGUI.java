...
public class TestirovanieGUI extends WebFrame {
    ...
    public TestirovanieGUI() {
        ...
        String[] subjects = {
                ...
                "Основы Web дизайна",
                "Программирование на Ассемблера",
                "Программирование на С#",
                "Программирование на С++",
                "Разработка web-сценариев для серверных приложений",
                ...
                "Intranet-технология",
                "Автоматизация систем экологической безопасности производства",
                "Патентные исследования",
                "Подсистемы планирования в АСУ твердосплавного производства",
                "Теория принятия решений",
                "Технология разработки систем искусственного интеллекта",
            ...
            if (gtList.size() > 0) {
                try {
                    for (GroupTest gt : gtList) {
                        ...
                        testirovanie.save(timePrefix + " " + gt.getSubjectName(), qaList);
                    }
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
